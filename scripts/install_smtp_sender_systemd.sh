#!/usr/bin/env bash
# install_smtp_sender_systemd.sh
#
# Install and start the SES S3 Mailbox local SMTP sender as a systemd service.

set -euo pipefail

SERVICE_NAME="ses-s3-mailbox-smtp-sender"
...
echo "  ss -lntp | grep 2525                    # check port"
